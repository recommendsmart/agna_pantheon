...
class SaferpayHandler implements SaferpayHandlerInterface, ContainerInjectionInterface {
  ...
  private function logError($exception) {
    ...
    $message = new FormattableMarkup('API error. Error details are as follows:<pre>@response</pre>', ['@response' => print_r(json_decode($response_info), TRUE)]);
