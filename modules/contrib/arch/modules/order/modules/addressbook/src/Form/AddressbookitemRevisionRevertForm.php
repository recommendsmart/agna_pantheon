...
class AddressbookitemRevisionRevertForm extends ConfirmFormBase {
   ...
   *   The time service.
   */
  public function __construct(EntityStorageInterface $addressbookitem_storage, DateFormatterInterface $date_formatter, TimeInterface $time) {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('entity.manager')->getStorage('addressbookitem'),
