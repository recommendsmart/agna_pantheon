...
namespace Drupal\arch_product\Plugin\views\wizard;
...
/**
 * Tests creating product views with the wizard.
 *
 * @ViewsWizard(
 *   id = "product",
 *   base_table = "arch_product_field_data",
 *   title = @Translation("Product", context = "arch_product")
 * )
 */
class Product extends WizardPluginBase {
   ...
   * @var string
   */
  protected $createdColumn = 'product_field_data-created';
  ...
  public function getAvailableSorts() {
    ...
    return [
      'arch_product_field_data-title:ASC' => $this->t('Title'),
    ];
  }
  ...
  protected function defaultDisplayOptions() {
    ...
    // Add the title field, so that the display has product if the user switches
    // to a row style that uses fields.
    /* Field: Product: Title */
    $display_options['fields']['title']['id'] = 'title';
    $display_options['fields']['title']['table'] = 'arch_product_field_data';
    $display_options['fields']['title']['field'] = 'title';
    $display_options['fields']['title']['entity_type'] = 'product';
  ...
  protected  function displayOptionsRow(&$display_options, $row_plugin, $row_options) {
    switch ($row_plugin) {
      case 'full_posts':
        $display_options['row']['type'] = 'entity:product';
  ...
  protected function buildFilters(&$form, FormStateInterface $form_state) {
    ...
    foreach ($bundles as $bundle) {
      $display = $this->entityDisplayRepository->getFormDisplay($this->entityTypeId, $bundle, 'default');
