...
/**
 * Tests creating product revision views with the wizard.
 *
 * @ViewsWizard(
 *   id = "product_revision",
 *   base_table = "arch_product_field_revision",
 *   title = @Translation("Product revisions", context = "arch_product")
 * )
 */
class ProductRevision extends WizardPluginBase {
   ...
   * {@inheritdoc}
   *
   * Product revisions do not support full posts or teasers, so remove them.
   */
  ...
  protected function defaultDisplayOptions() {
    ...
    // Field: product revision: Created date.
    $display_options['fields']['changed']['id'] = 'changed';
    $display_options['fields']['changed']['table'] = 'arch_product_field_revision';
    $display_options['fields']['changed']['field'] = 'changed';
    $display_options['fields']['changed']['entity_type'] = 'product';
    ...
    // Field: product revision: Title.
    $display_options['fields']['title']['id'] = 'title';
    $display_options['fields']['title']['table'] = 'arch_product_field_revision';
