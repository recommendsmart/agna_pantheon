...
/**
 * Provides the product bundle variation condition for orders.
 *
 * @CommerceCondition(
 *   id = "order_product_bundle_variation",
 *   label = @Translation("Product bundle variation"),
 *   display_label = @Translation("Order contains specific product bundle variation"),
 *   category = @Translation("Commerce Product Bundles"),
 *   entity_type = "commerce_order",
 *   weight = -1,
 * )
 */
class OrderProductBundleVariation extends ConditionBase implements ContainerFactoryPluginInterface {

  use ProductBundleVariationTrait;

  /**
   * OrderProductBundleVariation constructor.
   *
  ...
  public function evaluate(EntityInterface $entity) {
    ...
    foreach ($order->getItems() as $order_item) {
      ...
      if (!$negate && isset($product_ids[$purchased_entity->id()])) {
        return TRUE;
      }
