...
class NotificationForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    if ($result == SAVED_NEW) {
      ...
      $this->logger('notification_system_database')->notice('Created new notification %label', $logger_arguments);
    }
    else {
      $this->messenger()->addStatus($this->t('The notification %label has been updated.', $message_arguments));
      $this->logger('notification_system_database')->notice('Updated new notification %label.', $logger_arguments);
    }
