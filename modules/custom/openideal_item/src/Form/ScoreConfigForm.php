...
namespace Drupal\openideal_item\Form;
...
class ScoreConfigForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'openideal_item_score_config_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('openideal_item.scoreconfig');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('openideal_item.scoreconfig')
