 ...
 *
 * @Block(
 *  id = "openideal_item_flag_and_like_block",
 ...
 * )
 */
class OpenidealItemFlagAndLikeBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    if ($node = $this->getEntity($this->getContexts())) {
      ...
      $build['#theme'] = 'openideal_item_flag_and_like_block';
