 ...
 * )
 */
class OpenidealItemUpdateInfo extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   * Openideal helper.
   *
   * @var \Drupal\openideal_item\OpenidealHelper
   */
  protected $helper;
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $container->get('openideal_item.helper'),
  ...
  public function build() {
    ...
    if ($node = $this->getEntity($this->getContexts())) {
      $build = ['#theme' => 'openideal_item_info_block'];
      ...
      if ($member && $member->hasPermission('update any group_node:item entity')) {
