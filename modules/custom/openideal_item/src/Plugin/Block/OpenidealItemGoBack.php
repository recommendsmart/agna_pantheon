 ...
 *
 * @Block(
 *  id = "openideal_item_go_back_block",
 *  admin_label = @Translation("Go back"),
 * )
 */
class OpenidealItemGoBack extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new OpenidealItemGoBack object.
   *
  ...
  public function build() {
    ...
    if ($node instanceof NodeInterface) {
      ...
      switch ($bundle) {
        case 'item':
          $url = Url::fromRoute('view.items.all_items_page');
          break;
