...
class ProjectController extends ControllerBase implements ContainerInjectionInterface {
  ...
  public function revisionOverview(ProjectInterface $burndown_project) {
    ...
    $build['#title'] = $has_translations ? $this->t('@langname revisions for %title', ['@langname' => $langname, '%title' => $burndown_project->label()]) : $this->t('Revisions for %title', ['%title' => $burndown_project->label()]);
