...
/**
 * Provides a 'OpenfarmUserAccount' block.
 *
 * @Block(
 *  id = "openfarm_user_user_account_block",
 ...
 * )
 */
class OpenfarmUserAccount extends BlockBase implements ContainerFactoryPluginInterface {
