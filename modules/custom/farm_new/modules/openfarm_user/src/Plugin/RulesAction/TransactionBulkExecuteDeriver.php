...
namespace Drupal\openfarm_user\Plugin\RulesAction;
 ...
 *
 * @see \Drupal\openfarm_user\Plugin\RulesAction\TransactionBulkExecute
 */
class TransactionBulkExecuteDeriver extends DeriverBase implements ContainerDeriverInterface {
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    ...
    // Record node.
    $contexts['record'] = ContextDefinition::create('entity:node')
      ->setLabel($this->t('Record node'))
      ->setRequired(TRUE)
      ->setAssignmentRestriction(ContextDefinitionInterface::ASSIGNMENT_RESTRICTION_SELECTOR)
      ->setDescription($this->t('The record that was published.'));
    ...
    $contexts['target_entity'] = ContextDefinition::create('entity:user')
      ...
      ->setRequired(TRUE)
      ->setAssignmentRestriction(ContextDefinitionInterface::ASSIGNMENT_RESTRICTION_SELECTOR)
      ->setDescription($this->t('The user who created an record.'));
