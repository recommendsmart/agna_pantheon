 ...
 *
 * @RulesAction(
 *   id = "openfarm_user_potins_transaction_bulk_execute",
 *   deriver = "Drupal\openfarm_user\Plugin\RulesAction\TransactionBulkExecuteDeriver",
 * )
 */
class TransactionBulkExecute extends RulesActionBase implements ContainerFactoryPluginInterface {
  ...
  private function getUsers() {
    ...
    $group_contents = $storage->loadByEntity($this->getContextValue('record'));
