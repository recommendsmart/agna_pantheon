...
final class OpenfarmUserEvents {
   ...
   * @var string
   */
  const OPENFARM_USER_MENTION = 'openfarm_user.user_mention';
   ...
   * @var string
   */
  const OPENFARM_USER_JOINED_GROUP = 'openfarm_user.user_joined_group';
   ...
   * @var string
   */
  const OPENFARM_USER_LEFT_GROUP = 'openfarm_user.user_left_group';
   ...
   * @var string
   */
  const OPENFARM_USER_JOINED_THE_SITE = 'openfarm_user.user_joined_site';
