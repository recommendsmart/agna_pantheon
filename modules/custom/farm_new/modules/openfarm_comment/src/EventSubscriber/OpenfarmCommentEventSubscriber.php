...
namespace Drupal\openfarm_comment\EventSubscriber;
...
/**
 * Class OpenfarmCommentEventSubscriber.
 */
class OpenfarmCommentEventSubscriber implements EventSubscriberInterface {
  ...
  /**
   * OpenfarmCommentEventSubscriber constructor.
   *
