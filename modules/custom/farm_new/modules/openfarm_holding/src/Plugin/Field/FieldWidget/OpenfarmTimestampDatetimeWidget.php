...
namespace Drupal\openfarm_holding\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the OpenrecordL 'datetime timestamp' widget.
 *
 * @FieldWidget(
 *   id = "openfarm_datetime_timestamp",
 *   label = @Translation("Openfarm Datetime Timestamp"),
 *   field_types = {
 *     "timestamp"
 *   }
 * )
 */
class OpenfarmTimestampDatetimeWidget extends TimestampDatetimeWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['#suffix'] = '<div class="holding-schedule-local-machine-time"></div>';
    $element['#attached']['library'][] = 'openfarm_holding/openfarm_holding.schedule';
    return $element;
  }
