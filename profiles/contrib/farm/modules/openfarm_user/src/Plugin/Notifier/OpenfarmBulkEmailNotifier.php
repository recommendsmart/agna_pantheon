...
namespace Drupal\openfarm_user\Plugin\Notifier;
 ...
 * )
 */
class OpenfarmBulkEmailNotifier extends MessageNotifierBase {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition, MessageInterface $message = NULL) {
    ...
    $instance->helper = $container->get('openfarm_record.helper');
