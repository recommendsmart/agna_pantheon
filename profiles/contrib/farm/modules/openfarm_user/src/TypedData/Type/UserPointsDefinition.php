...
namespace Drupal\openfarm_user\TypedData\Type;
  ...
  public function getPropertyDefinitions() {
    if (!isset($this->propertyDefinitions)) {
      ...
      $this->propertyDefinitions['comment'] = DataDefinition::create('string')
        ...
        ->setRequired(TRUE);
      $this->propertyDefinitions['record'] = DataDefinition::create('string')
        ->setLabel($this->t('Record'))
        ->setDescription($this->t('Record weight'))
        ->setRequired(TRUE);
    }
