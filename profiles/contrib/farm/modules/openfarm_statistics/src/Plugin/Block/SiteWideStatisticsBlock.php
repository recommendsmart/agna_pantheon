...
class SiteWideStatisticsBlock extends BlockBase {
  ...
  public function build() {
    ...
    $build['#content'] = [
      'records' => [
        'bottom' => [
          '#lazy_builder' => ['openfarm_statistics.lazy_builder:getRecords', []],
      ...
      'members' => [
        'bottom' => [
          '#lazy_builder' => ['openfarm_statistics.lazy_builder:getMembers', []],
          '#create_placeholder' => TRUE,
        ],
      ...
      'comments' => [
        'bottom' => [
          '#lazy_builder' => ['openfarm_statistics.lazy_builder:getComments', []],
          '#create_placeholder' => TRUE,
        ],
      ...
      'votes' => [
        'bottom' => [
          '#lazy_builder' => ['openfarm_statistics.lazy_builder:getVotes', []],
          '#create_placeholder' => TRUE,
        ],
        'title' => $this->t('Votes'),
        'img_class' => 'like_tag',
