(function ($, Drupal) {
   ...
   */
  Drupal.behaviors.OpenfarmSlideshowConfiguration = {
    attach: function (context, settings) {
      $('.pswp').once('openfarm_slideshow_remove_class').removeClass('pswp-hidden');
      $('.openfarm-slideshow', context).once('openfarm_slideshow_configuration').each(function () {
